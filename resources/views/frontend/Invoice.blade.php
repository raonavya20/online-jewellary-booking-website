...
<body style="background-color:gray"  onload="window.print()">
    <div class="invoice_body col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12" id="htmlContent">
        ...
        <div class="sub_div col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                ...
                <p class="invoiced_to_details"> {{$data['userdetail']->name}} </p>
                <p class="invoiced_to_details"> {{$data['profile']->mobile}} </p>
                <p class="invoiced_to_details">{{$data['profile']->email}} </p>
            </div>
                <div class="col-lg-offset-6 col-md-offset-6 col-lg-3 col-md-3 col-sm-6 col-xs-6">
